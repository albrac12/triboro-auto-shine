...
const positions: Position[] = [
  {
    ...
    responsibilities: [
      ...
      "Inspect finished surfaces for defects and perform touch-ups to ensure a flawless final result. Maintain a clean and organized work area while adhering to safety protocols",
    ],
    requirements: [
      ...
      "Ability to perform heavy lifting safely while handling vehicle parts or materials during repairs or prep work",
    ],
  },
];
